"""Runtime autonome des politiques de mobilite experimentees en v16."""
...
def model_custom_objects() -> Dict[str, Any]:
    """Force la classe de politique autonome au chargement du ZIP v16."""
    return {"policy_class": SituationMaskedMlpLstmPolicy}


def configure_model(model, boat_type: str) -> None:
    """Valide le modele exclusivement contre l'interface v16."""
...
class RuntimeController:
    """Controleur complet et autonome des bots v16."""
...
def attach_controller(bot: Dict[str, Any], ai_name: str, model) -> None:
    """Initialise tout l'etat runtime propre au bot v16."""
    bot["ai_tree"] = None
