"""Evalue deterministement un modele de mobilite avec le runtime isole v17."""
...
from rl.bot_versions.v17 import geometry, navigable_path, rl_control, runtime, waypoints
...
CASES = {
    "destroyer": {
        ...
        "model": ROOT / "rl/models_rl/aidest_mobility_runtime_v17/checkpoints/source_v16.zip",
        "seed": 533542,
        "alias": "rl_aidest_mobility_runtime_v17:source_v16",
        "report": ROOT / "rl/models_rl/aidest_mobility_runtime_v17/evaluation/segmented_runtime_v17_near_axis_final500_seed533542.json",
    },
    "submarine": {
        "config": ROOT / "rl/configs/aisub_mobility_runtime_v14.json",
        "model": ROOT / "rl/models_rl/aisub_mobility_runtime_v17/checkpoints/source_v16.zip",
        "seed": 523542,
        "alias": "rl_aisub_mobility_runtime_v17:source_v16",
        "report": ROOT / "rl/models_rl/aisub_mobility_runtime_v17/evaluation/segmented_runtime_v17_near_axis_final500_seed523542.json",
    },
}
...
def install_v17_environment() -> None:
    """Force l'evaluateur partage a utiliser exclusivement le runtime v17."""
...
def main() -> None:
    ...
    report = {
        ...
        "runtimeManifestSha256": file_sha256(
            ROOT / "rl/bot_versions/v17/manifest.json"),
        "protocol": {
            "episodes": episodes,
            "seed": case["seed"],
            "deterministic": True,
            ...
            "nearAxisSearchRadiusMeters": (
                navigable_path.ROUTE_NEAR_AXIS_SEARCH_RADIUS_M),
            "routeStrategy": "safe_aligned_then_near_axis_shortest_then_dijkstra",
